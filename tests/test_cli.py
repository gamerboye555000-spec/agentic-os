...
class TestDoctor(CliTestCase):
    ...
    def test_doctor_passes_on_clean_generated_demo(self):
        ...
        # writes power.json, and reading it must not create it. 21 → 25 → 30:
        # U-M2's four mandated memory-claim checks joined the set, then
        # U-M3's five memory-graph checks.
